    ...
    def read_vehicle_code(self):
        ...
        if result[0] == True:
            ...
            for i in range(int(len(vf33_params_buffer)/4)):
                ...
                vf33_param = round(struct.unpack('<f', payload)[0], 2)
                if vf33_param == 0:
                    vf33_param = round(struct.unpack('<f', payload)[0], 3)
            ...
            for i in range(int(len(vf34_params_buffer)/4)):
                ...
                vf34_param = round(struct.unpack('<f', payload)[0], 2)
                if vf34_param == 0:
                    vf34_param = round(struct.unpack('<f', payload)[0], 3)
            ...
            for i in range(int(len(vf35_params_buffer)/4)):
                ...
                vf35_param = round(struct.unpack('<f', payload)[0], 2)
                if vf35_param == 0:
                    vf35_param = round(struct.unpack('<f', payload)[0], 3)
            ...
            for i in range(int(len(vf36_params_buffer)/4)):
                ...
                vf36_param = round(struct.unpack('<f', payload)[0], 2)
                if vf36_param == 0:
                    vf36_param = round(struct.unpack('<f', payload)[0], 3)
